...
--// PIXEL-PERFECT TEXT REPLICA (Fresh Initialization)
local function showSentGiftToast(rawItemName)
    ...
    sendingLabel.Size = UDim2.new(1, 0, 0, 40)
    sendingLabel.AnchorPoint = Vector2.new(0.5, 0)
    sendingLabel.Position = UDim2.new(0.5, 0, 0, 60)
    sendingLabel.BackgroundTransparency = 1
    
    -- Text appearance config
    sendingLabel.Font = Enum.Font.GothamBold
    sendingLabel.TextSize = 29
    sendingLabel.TextColor3 = Color3.fromRGB(212, 162, 26) -- Main Gold
    sendingLabel.TextXAlignment = Enum.TextXAlignment.Center
    sendingLabel.RichText = true
    
    -- Subtle dark shadow offset configuration
    sendingLabel.TextStrokeColor3 = Color3.fromRGB(17, 17, 17)
    sendingLabel.TextStrokeTransparency = 0.8
    
    -- Sharper clean edges via UIStroke
    local stroke1 = Instance.new("UIStroke", sendingLabel)
    stroke1.Thickness = 2
    stroke1.Color = Color3.fromRGB(17, 17, 17) -- Dark outline
    stroke1.JoinMode = Enum.LineJoinMode.Round
    
    -- Formatted rich string parsing high-saturation gold areas
    local highlightHex = "rgb(225, 184, 43)"
    sendingLabel.Text = "Sending gift <font color='".. highlightHex .."'>&lt;Permanent " .. cleanItemName .. "&gt;</font> to " .. targetName .. "..."
    ...
    successLabel.TextSize = 29
    successLabel.TextColor3 = Color3.fromRGB(111, 255, 133) -- Saturated mint green
    successLabel.TextXAlignment = Enum.TextXAlignment.Center
    
    -- Subtle drop shadow config
    successLabel.TextStrokeColor3 = Color3.fromRGB(17, 17, 17)
    successLabel.TextStrokeTransparency = 0.8
    successLabel.Text = "Gift sent successfully!"
    
    local stroke2 = Instance.new("UIStroke", successLabel)
    stroke2.Thickness = 2
    stroke2.Color = Color3.fromRGB(17, 17, 17)
    stroke2.JoinMode = Enum.LineJoinMode.Round

    -- Default time configuration tracking
